...
*/
SELECT Clientes.Nombre AS Cliente, Productos.Nombre AS Producto, Pedidos_Productos.Cantidad,
 Pedidos.Fecha_Pedido FROM Clientes JOIN Pedidos ON Clientes.ID_Cliente = Pedidos.ID_Cliente
